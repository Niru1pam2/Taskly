...
export type CreateProjectDialogProps = z.infer<typeof projectSchema>;
...
export default function CreateProjectDialog({
  ...
  const form = useForm<CreateProjectDialogProps>({
  ...
  const onSubmit = (data: CreateProjectDialogProps) => {
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Popover>
                        ...
                        <PopoverContent
                          className="w-md max-w-60 overflow-y-auto"
                          align="start"
                        >
